...
function themeit_tiny_mce_before_init( $settings )
{
	...
	$style_formats = array(
		...
		array( 'title' => 'Buttons' ),
		array( 'title' => 'Blue',		'inline' => 'span',  'classes' => 'blue button' ),
      
		array( 'title' => 'Green',		'inline' => 'span',  'classes' => 'green button' ),
      
		array( 'title' => 'Orange',		'inline' => 'span',  'classes' => 'orange button' ),
      
		array( 'title' => 'Gray',		'inline' => 'span',  'classes' => 'gray button' ),
		
		array( 'title' => 'Purple',		'inline' => 'span',  'classes' => 'purple button' )
	);
