...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.1.1/css/bootstrap-theme.min.css" />
    ...
    <link type="text/css" rel="stylesheet" href="/assets/css/common/snapable-theme.css?<?= md5_file('assets/css/common/snapable-theme.css') ?>" />
		<link type="text/css" rel="stylesheet" href="/assets/css/common/header.css?<?= md5_file('assets/css/common/header.css') ?>" />
		<link type="text/css" rel="stylesheet" href="/assets/css/common/footer.css?<?= md5_file('assets/css/common/footer.css') ?>" />
    <?php
    // external resources
    if ( isset($ext_css) ) {
        // add assets
    ...
    <script type="text/javascript" src="//statuspage-production.s3.amazonaws.com/se-v1.js"></script>
