<div class="inner">
	...
	<ul class="overlay-tabs">
		<li id="overlay-tabs-add" class="active fifty">Add</li><li id="overlay-tabs-notify" class="fifty">Notify</li>
	</ul>
	
	<div id="add-guests-wrap" class="tab-content">
		...
		<div id="guests-upload" class="guests-hide">
			...
			<div id="guests-file-uploader"><input type="file" /> <input id="guests-upload-csv" type="button" value="Upload" /></div>
			
			<p><em>The expected format is <strong>Name, Email, Type</strong></em>	
			<br />&rarr; <a href="#" id="guests-file-how-to-csv-link">How-to Save a CSV file</a> &nbsp; &nbsp; &rarr; <a href="#">Download a Sample CSV file</a></p>		
		...
		<div id="guests-manual" class="guests-hide">
			...
			<br /><em>The expected format is <strong>Name, Email, Type</strong></em>
	...
	<div id="notify-guests" class="tab-content">
