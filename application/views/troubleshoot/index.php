...
<div style="text-align:center">
        <h2>Your Computer Information</h2>
            <?php
            $os = '';
            $os_starter = '<h4>Operating System:</h4><p class="right-bar">';
            $os_finish = '</p>';
            $full = '';
            $handheld = '';
            ...
            if ( $browser_info[8] == 'mobile' ) {
                $handheld = '<h4>Handheld Device:</h4><p class="right-bar">';
            ...
            $full .= $handheld . $os . '<h4>Browser / UA:</h4><p class="right-bar">';
