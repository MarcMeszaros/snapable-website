...
<p>Commitment to Data Security Your personally identifiable information is kept secure. Only authorized employees, agents and contractors (who have agreed to keep information secure and confidential) have access to this information.</p>

<p>We reserve the right to make changes to this policy. Any changes to this policy will be posted.</p>

<p><b>Snapable</b> is using a 256-bit SSL certificate. This SSL Certificate can provide encryption between your web browser and our web server so that personal information can be transmitted over the Internet securely.</p>

<p>During normal browsing, the padlock is open when you are giving and receiving non-encrypted information. You may not see the padlock during normal browsing. If the padlock appears closed, you have entered a secure area. Any communication is then encrypted.</p>